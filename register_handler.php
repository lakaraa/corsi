...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        echo "<script>alert('Registrazione avvenuta con successo!'); window.location.href='login.php';</script>";

    } catch (PDOException $e) {
        // Handle errors
        echo "<script>alert('Errore: " . addslashes($e->getMessage()) . "'); window.location.href='register.php';</script>";
    }
} else {
